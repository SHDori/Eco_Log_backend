...
public class UserServie {
    ...
    public ProfileViewResponseDto getUserProfileInfo(Long requestUserId,Long targetUserId){
        ...
        // 유저의정보를넣었다.
        ProfileViewResponseDto resultProfileDto = new ProfileViewResponseDto(targetUserId,targetUser.getProfiles().getNickName(), (long) targetUser.getPosts().size(),targetUserSummary,targetUser.getProfiles().getSelfIntroduce(),targetUser.getProfiles().isPublic(),targetUser.getCreatedDate());
        // total Count는 추후 수정
